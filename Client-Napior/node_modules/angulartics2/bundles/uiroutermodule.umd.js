(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('angulartics2'), require('@uirouter/core'), require('rxjs/Subject')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'angulartics2', '@uirouter/core', 'rxjs/Subject'], factory) :
	(factory((global.angulartics2 = global.angulartics2 || {}, global.angulartics2.uiroutermodule = {}),global.ng.core,global.angulartics2,global['@uirouter/core'],global.Rx));
}(this, (function (exports,core,angulartics2,core$1,Subject) { 'use strict';
