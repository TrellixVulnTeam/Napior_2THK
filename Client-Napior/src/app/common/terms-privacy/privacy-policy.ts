export class PrivacyPolicy {
  ...
  document = [
    ...
    {
      sectionTitle: 'Gathering, Use and Disclosure of Non-Personally-Identifying Information.',
      paragraphs: [
    ...
    {
      sectionTitle: 'Aggregated and Non-Personally-Identifying Information',
      paragraphs: [
    ...
    {
      sectionTitle: 'Collection, Use, and Disclosure of Personally-Identifying Information',
      paragraphs: [
    ...
    {
      sectionTitle: 'Company Communications',
      paragraphs: [
    ...
    {
      sectionTitle: 'Company Disclosures',
      paragraphs: [
    ...
    {
      sectionTitle: 'Changing Personally-Identifying Information; Account Termination',
      paragraphs: [
    ...
    {
      sectionTitle: 'Collection and Use of Information by Third Parties Generally',
      paragraphs: [
    ...
    {
      sectionTitle: 'Privacy Policy Changes',
      paragraphs: [
    ...
    {
      sectionTitle: 'California Privacy Rights',
      paragraphs: [
    ...
    {
      sectionTitle: 'Do-Not-Track Policy',
      paragraphs: [
